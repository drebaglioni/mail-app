...
// Local wrapper around the shared threadMatchesSplit util so the rest of
// this file can keep passing EmailThread objects around without exposing
// split-conditions to that type. Preserves our fork's assignment-override
// behavior: a manually-assigned split wins over the rule-based match.
