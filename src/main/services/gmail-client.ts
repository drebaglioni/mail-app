...
export class GmailClient {
  ...
  async getHistoryChanges(startHistoryId: string): Promise<{
    ...
    try {
      // Fetch INBOX and SENT history in parallel. Our fork-specific labelsAdded
      // handler below still picks up re-inboxed mail because INBOX-add events
      // show up under the INBOX label stream.
